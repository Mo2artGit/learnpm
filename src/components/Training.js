...
function Training() {
  ...
  const courses = [
    ...
    { id: 5, name: 'Certified SAFe Agilist', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl5.png'] },
    ...
    { id: 8, name: 'Certified SAFe® Government Practitioner', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl8.png'] },
    { id: 9, name: 'Certified SAFe® Program Consultant', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl9.png'] },
    { id: 10, name: 'Certified SAFe® Advanced Scrum Master', certifyingBody: 'Scaled Agile 5.0', role: 'Scrum Master', logo: images['cl10.png'] },
    { id: 11, name: 'Certified SAFe® DevOps Practitioner', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl11.png'] },
    { id: 12, name: 'Certified SAFe® Architect', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl12.png'] },
    { id: 13, name: 'Certified SAFe® Practitioner', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl13.png'] },
    { id: 14, name: 'Certified SAFe® Release Train Engineer', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl14.png'] },
    { id: 15, name: 'Certified SAFe® Agile Software Engineer', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl15.png'] },
    { id: 16, name: 'Certified SAFe® Lean Portfolio Manager', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl16.png'] },
    { id: 17, name: 'Certified SAFe® Agile Product Manager', certifyingBody: 'Scaled Agile 5.0', role: 'Other', logo: images['cl17.png'] },
    ...
    { id: 20, name: 'Certified Agile Leadership (CAL1)', certifyingBody: 'Leadership', role: 'Other', logo: images['cl20.png'] },
    { id: 21, name: 'Project Management Professional', certifyingBody: 'PMI', role: 'Other', logo: images['cl21.png'] },
    { id: 22, name: 'PMI Agile Certified Practitioner', certifyingBody: 'PMI', role: 'Other', logo: images['cl22.png'] },
    { id: 23, name: 'Value Stream Workshop', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl23.jpeg'] },
    { id: 24, name: 'SAFe® Portfolio Management', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl24.jpeg'] },
    { id: 25, name: 'Program Increment Workshop', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl25.jpeg'] },
    { id: 26, name: 'Inspect & Adapt', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl26.jpeg'] },
    { id: 27, name: 'Product Management Workshop', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl27.jpeg'] },
    { id: 28, name: 'Team Building', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl28.jpeg'] },
    { id: 29, name: 'Customized Scrum/Kanban Workshop', certifyingBody: 'Corporate Training', role: 'Other', logo: images['cl29.jpeg'] },
  ];
