...
const UpcomingCourses = () => {
  ...
  return (
    <div className='ps-3 overflow-x-hidden'>
      <Row className="mt-5">
        <Col xs={3} style={{ maxWidth: '250px', flexBasis: '250px', flexGrow: 0, flexShrink: 0 }}>
          <div className="p-3 bg-secondary rounded">
            <h5 className='text-light'><FaFilter /> Filter</h5>
            {/* Course Type Filter */}
            <DropdownButton title="Course Type" onSelect={(e) => handleFilterChange('courseType', e)} className="w-100 mb-3">
            ...
            {/* Calendar Filter */}
            <Button onClick={() => setShowCalendar(!showCalendar)} style={{ cursor: 'pointer' }} className="w-100 mb-3">
              Calendar
            </Button>
            {showCalendar && (
            ...
            {/* Location Filter */}
            <DropdownButton title="Location" onSelect={(e) => handleFilterChange('location', e)} className="w-100 mb-3">
              <Dropdown.Item eventKey="">All</Dropdown.Item>
            ...
            {/* Instructor Filter */}
            <DropdownButton title="Instructor" onSelect={(e) => handleFilterChange('instructor', e)} className="w-100 mb-3">
              <Dropdown.Item eventKey="">All</Dropdown.Item>
